...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="<?php echo e(route('password.request')); ?>" class="text-sm hover:underline" style="color: #6C9BCF;">
        Lupa password?
    </a>
</div>
...
</html><?php /**PATH C:\laragon\www\smartschedule\resources\views/auth/login.blade.php ENDPATH**/ ?>