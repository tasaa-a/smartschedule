...
<div class="bg-white rounded-2xl shadow-sm">
    <div class="p-6 border-b border-gray-100">
        ...
        <p class="text-sm text-gray-500">Ubah data guru</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="nama" 
                        ...
                        value="<?php echo e(old('nama', $guru->nama)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="nip" 
                        class="w-full border rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#6C9BCF]" 
                        style="border-color: #E9ECEF;" 
                        value="<?php echo e(old('nip', $guru->nip)); ?>" required>
                    <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="email" name="email" 
                        class="w-full border rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#6C9BCF]" 
                        style="border-color: #E9ECEF;" 
                        value="<?php echo e(old('email', $guru->user->email)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label class="block text-sm font-bold mb-2" style="color: #4A5568;">Password (Kosongkan jika tidak diubah)</label>
                    <div class="relative">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartschedule\resources\views/admin/guru/edit.blade.php ENDPATH**/ ?>