...
<div class="bg-white rounded-2xl shadow-sm p-6">
    ...
    <div class="grid grid-cols-1 gap-6 mt-6">
        <a href="<?php echo e(route('siswa.jadwal')); ?>" class="bg-blue-50 rounded-2xl p-6 hover:shadow-lg transition flex items-center gap-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartschedule\resources\views/siswa/dashboard.blade.php ENDPATH**/ ?>