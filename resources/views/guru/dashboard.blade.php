...
<div class="bg-white rounded-2xl shadow-sm p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        <a href="{{ route('guru.jadwal') }}" class="bg-blue-50 rounded-2xl p-6 hover:shadow-lg transition flex items-center gap-4">
        ...
        <a href="{{ route('guru.preferensi') }}" class="bg-green-50 rounded-2xl p-6 hover:shadow-lg transition flex items-center gap-4">
