    ...
    <div class="stat-card-pastel p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold" style="color: #4A5568;">{{ $totalGuru ?? 0 }}</p>
            </div>
    ...
    <div class="stat-card-pastel p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold" style="color: #4A5568;">{{ $totalSiswa ?? 0 }}</p>
            </div>
    ...
    <div class="stat-card-pastel p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold" style="color: #4A5568;">{{ $totalKelas ?? 0 }}</p>
            </div>
    ...
    <div class="stat-card-pastel p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold" style="color: #4A5568;">{{ $totalMapel ?? 0 }}</p>
            </div>
    ...
    <div class="stat-card-pastel p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold" style="color: #4A5568;">{{ $totalJadwal ?? 0 }}</p>
            </div>
            <div class="w-14 h-14 rounded-2xl flex items-center justify-center bg-pastel-blue-light">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <a href="{{ route('admin.guru.create') }}" class="bg-white rounded-2xl p-6 shadow-sm card-hover flex items-center gap-4">
        <div class="w-14 h-14 rounded-2xl flex items-center justify-center bg-pastel-blue-light">
    ...
    <a href="{{ route('admin.siswa.create') }}" class="bg-white rounded-2xl p-6 shadow-sm card-hover flex items-center gap-4">
        <div class="w-14 h-14 rounded-2xl flex items-center justify-center bg-pastel-green-light">
    ...
    <a href="{{ route('admin.jadwal.create') }}" class="bg-white rounded-2xl p-6 shadow-sm card-hover flex items-center gap-4">
        <div class="w-14 h-14 rounded-2xl flex items-center justify-center bg-pastel-pink-light">
