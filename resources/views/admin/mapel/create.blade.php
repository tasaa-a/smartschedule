...
<div class="bg-white rounded-2xl shadow-sm p-6">
    ...
    <form action="{{ route('admin.mapel.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_mapel" class="w-full border rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#6C9BCF]" placeholder="Contoh: Pemrograman Web" required>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="durasi_jam" class="w-full border rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#6C9BCF]" placeholder="Contoh: 2" value="2" required>
