...
<head>
    ...
    <title>SmartSchedule - Reset Password</title>
        ...
        <div class="max-w-md w-full">
            ...
            <div class="card-pastel rounded-3xl shadow-2xl p-8">
                <div class="text-center mb-6">
                    <i class="fas fa-lock-open text-4xl" style="color: #6C9BCF;"></i>
                    <h2 class="text-2xl font-bold mt-3" style="color: #4A5568;">Reset Password</h2>
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    {{-- Password Baru --}}
                    <div class="mb-4">
                        <label class="block text-sm font-bold mb-2" style="color: #4A5568;">Password Baru</label>
                        <div class="relative">
                    ...
                    {{-- Konfirmasi Password --}}
                    <div class="mb-6">
                        <label class="block text-sm font-bold mb-2" style="color: #4A5568;">Konfirmasi Password</label>
                        <div class="relative">
                            <i class="fas fa-lock absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
